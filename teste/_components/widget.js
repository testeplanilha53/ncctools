function  widget(){
    ...
    `<div class="tools container-sm ">
        <div class="wdg">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm border bg-dark-subtle">
                <div class="wdg-content-input row">
                    <label for="exampleFormControlTextarea1" class="form-label">Atalhos</label>
                    <div class="col-md-6">
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-grid gap-2">
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <button class="form-control btn btn-primary" type="button">Atalho 1</button>
