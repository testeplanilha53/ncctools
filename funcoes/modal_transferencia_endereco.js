...
function inserir_modelo_transferencia(){
    ...
    var texto = `Cliente solicita transferência de endereço para: <hr> <b> Novo endereço:</b> ${novo_endereco} <hr> 1 x R$${V_transf},00 -- ponto principal<br> \n${v_tv} x R$25,00 -- ponto adc. TV<br> \n${v_wifi} x R$25,00 -- ponto adc. WI-FI<br> \n<b>VALOR TOTAL: R$${valor_total} em ${parcelas} vez(es)</b>\n<hr> Ciente do prazo máximo de 7 dias úteis, e que é necessário levar os dispositivos ao novo endereço. <hr> Confirmada a disponibilidade de conexão no local por: ${confirmacao_disponibilidade}`
