...
function tooltips_fun_Transferência_de_endereço_amparo(){
    ...
    var txt = `Cliente solicita transferência de endereço. Ciente do valor de R$ 100,00 (parcelado em 2 vezes), do prazo máximo de 7 dias úteis para ocorrer. Cliente já está no novo endereço. \n<hr> <b> Novo endereço:</b> \n<hr> Confirmado a disponibilidade de conexão no local por: \n`
...
function tooltips_fun_can_titular (){
    ...
    var txt = `Cliente solicita cancelamento da conexão. Informado de que tal solicitação será repassada para o setor responsável, que fará posterior contato para fins de conclusão/negociação. Cliente ciente da solicitação em sistema, sem mais dúvidas. \n<b>Motivo do cancelamento: </b> <hr> \n<b>Ofertado: </b> XXXXXX <hr> \n<b> Verificação com a supervisão: </b>`
...
function tooltips_fun_prob_ext_conclusao (){
    ...
    var txt = `Cliente relata falta de conexão. Identificado problema externo. Instruído a aguardar o reparo técnico ocorrer. Sem mais dúvidas.\n\n[Mensagem sobre o problema externo informado pela monitoria / supervisão].`
...
function tooltips_fun_prob_ext_suporte (){
    ...
    var txt = `Cliente relata falta de conexão. Identificado problema externo. Instruído a aguardar o reparo técnico ocorrer e ciente de que será feito posterior contato após a normalização. Ligar no nº XXXXXXXXXXX - falar com Sr.(a) XXXXXXXXXX. Sem mais dúvidas. \n\n[Mensagem sobre o problema externo informado pela monitoria / supervisão].`
...
function tooltips_fun_fora_do_prazo_vs (){
    ...
    var txt = `Cliente solicita informação sobre a visita técnica referente ao protocolo [número do protocolo]. Instruído a aguardar a visita ocorrer, uma vez que o escritório local afirma que ocorrerá no dia de XX/XX. <hr>\n\n<b> [Verificação com o escritório local] </b>:`
