...
<header class="conteiner-fluid _header">
  <nav class="navbar text-white m-auto p-2" style="max-width: 1920px; background: rgb(53, 54, 63);">
    ...
    <span id="botoes_mais_usuais">
        ...
        <button type="button" id="modelos" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter" data-toggle="tooltip" data-placement="bottom" title="Use seus modelos de preenchimento totalmente personalizáveis.">
