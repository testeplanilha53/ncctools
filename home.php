...
<nav class="Menu">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 _menu-sidebar " style="height: 100%;">
    ...
    <form class="d-flex" method="get" action="https://ncc.drozbase.cx/search?">
...
<span class="mx-2">Treinamento</span>
      ...
      <li >
        <a href="#" class="nav-link link-dark d-flex align-items-center sidebar_item text-white" href="./logout.php">
