                    ...
                    <div id="btn_atalhos">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col"><button type="button" id="" class="btn btn-info btn_atalho" data-toggle="tooltip" data-placement="top" title="Atalho" onmouseover="muda_title1()" onclick="atalho1()">Atalho 1</button> </div>
                                <div class="col"><button type="button" id="" class="btn btn-info btn_atalho" data-toggle="tooltip" data-placement="top" title="Atalho" onmouseover="muda_title2()" onclick="atalho2()">Atalho 2</button></div>
                                <div class="w-100"></div>
                                <div class="col"><button type="button" id="" class="btn btn-info btn_atalho" data-toggle="tooltip" data-placement="top" title="Atalho" onmouseover="muda_title3()" onclick="atalho3()">Atalho 3</button> </div>                                
                                <div class="col"><button type="button" id="" class="btn btn-info btn_atalho" data-toggle="tooltip" data-placement="top" title="Atalho" onmouseover="muda_title4()" onclick="atalho4()">Atalho 4</button> </div>
                                <div class="w-100"></div>
                                <div class="col"><button type="button" id="" class="btn btn-info btn_atalho" data-toggle="tooltip" data-placement="top" title="Atalho" onmouseover="muda_title5()" onclick="atalho5()">Atalho 5</button></div>
                                <div class="col"><button type="button" id="" class="btn btn-info btn_atalho" data-toggle="tooltip" data-placement="top" title="Atalho" onmouseover="muda_title6()" onclick="atalho6()">Atalho 6</button> </div>
