    ...
    <div class="container" id="tela_atendimento">
        <div class="row">
            ...
            <p id="tags_html" class="tags_show">
			   <button class="btn btn-outline-dark" onclick="add_tag('<hr>')">&lt;hr&gt;</button>
			   <button class="btn btn-outline-dark" onclick="add_tag('<b>')">&lt;b&gt;</button>
			   <button class="btn btn-outline-dark" onclick="add_tag('</b>')">&lt;/b&gt;</button>
               <span type="button" id="" class="btn btn-outline-dark btn_salvar_pend" onclick="salvar_pendencia()"> 
